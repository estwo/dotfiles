# Sets OS X defaults baesd on http://mths.be/osx
#
# Run ./configure-osx.sh to configure
...
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "xxx"
